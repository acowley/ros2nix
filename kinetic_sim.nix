{ Cocoa, apr, atk, boost, bzip2, cmake, console-bridge, extraPackages ? {}, fetchurl, gdk_pixbuf, glib, gtest, libobjc, log4cxx, lz4, mkRosCmakePackage, mkRosPythonPackage, opencv3, pango, pkgconfig, rosShell, sbcl, stdenv, tinyxml

# Needed by localPackagesn
, fetchFromGitHub, fetchzip, sqlite, zlib, minizip, pcre, expat, openssl, uriparser

, graphviz, gazebo7, ogre, protobuf, sdformat, ignition, freeimage, libxml2
, tbb, libyamlcpp, ... }@deps:
let
    rosPackageSet = {
